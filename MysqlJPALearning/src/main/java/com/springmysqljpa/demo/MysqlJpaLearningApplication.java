package com.springmysqljpa.demo;
...
import com.springmysqljpa.demo.repo.ExpenseRespository;

@SpringBootApplication
public class MysqlJpaLearningApplication implements CommandLineRunner {

	@Autowired
    ExpenseRespository repository;
	
	public static void main(String[] args) {
		SpringApplication.run(MysqlJpaLearningApplication.class, args);
	}
